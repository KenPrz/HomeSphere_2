    ...
    <div>
        <div :class="[
            ...
            <div class="flex flex-1">
                ...
                <div class="flex-1">
                    <div v-if="homeData.role == 'owner' || homeData.role == 'admin' || created_by == $page.props.auth.user.id" class="ms-1 mt-3">
            ...
            <div class="flex flex-col flex-1">
                ...
                <div class="flex">
                    ...
                    <button v-if="homeData.role == 'owner' || homeData.role == 'admin' || created_by == $page.props.auth.user.id" @click="deleteDevice" class="w-1/2 text-xs font-medium p-2" :class="[is_active.data ? 'hover:text-red-500': 'hover:text-red-400']">Delete</button>
                </div>
            </div>
        </div>
    </div>
