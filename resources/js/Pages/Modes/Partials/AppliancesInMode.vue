...
<template>
    <div class="w-full container flex flex-col">
        <section class="flex justify-between me-2">
            ...
            <button v-if="homeData.role == 'owner' || homeData.role == 'admin' || mode.created_by == $page.props.auth.user.id" @click="openAddApplianceModal"
        ...
        <section v-if="homeData.role == 'owner' || homeData.role == 'admin' || mode.created_by == $page.props.auth.user.id" class="flex justify-end me-2">
